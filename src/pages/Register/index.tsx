...
import {registerUser, authSelector, clearAllStates } from "../../stores/features/auth/authSlice";
...
function Main() {
    ...
    useEffect(() => {
        if (auth.isSuccess) {
            toastMessage('You have been registered sucessfully. Please check your email to activate your account.', 's');
                            ...
                            <div
                                ...
                                <form className="validate-form" onSubmit={onSubmit}>
                                    <div className="mt-8 intro-x">
                                        <TextInput register={register} errors={errors} name={'companyName'}
                                                   placeholder={'Company Name'}/>
                                        <br/>
                                        <TextInput register={register} errors={errors} name={'email'} type={'email'}
                                                   placeholder={'Email'}/>
                                        <br/>
                                        <TextInput register={register} errors={errors} name={'phone'}
                                                   placeholder={'Phone Number'}/>
                                        <br/>
                                        <TextInput register={register} errors={errors} name={'userName'}
                                                   placeholder={'User Name'}/>
                                        <br/>
                                        <TextInput register={register} errors={errors} name={'address'}
                                                   placeholder={'Local Address'}/>
                                        <br/>
                                        <TextInput register={register} errors={errors} name={'password'}
                                                   type={'password'} placeholder={'Password'}/>
                                        <br/>
                                        <TextInput register={register} errors={errors} name={'confirmPassword'}
