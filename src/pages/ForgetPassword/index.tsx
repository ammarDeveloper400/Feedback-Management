...
import {authSelector, forgetPassword,clearAllStates} from "../../stores/features/auth/authSlice";
...
function Main() {
    ...
    useEffect(() => {
        if (auth.isSuccess) {
            toastMessage('An email with your password reset link has been sent, if the provided email address is registered with us.', 's');
