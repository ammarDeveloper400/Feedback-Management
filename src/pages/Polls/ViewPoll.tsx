      ...
      <div className="grid grid-cols-12 gap-6 mt-5">
        ...
        <div className="col-span-12 lg:col-span-7 2xl:col-span-8">
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 intro-y box 2xl:col-span-6">
              ...
              {hosts?.facebookurl != "" &&
                ...
                <div className="relative flex items-center">
                  ...
                  <div className=" mr-auto">
                    <a href={hosts?.linkedin} target="_blank" className="font-medium">
                      {hosts?.linkedin}
                    </a>
                  </div>
                </div>
                ...
                {hosts?.tiktokurl != "" &&
                    ...
                    <div className=" mr-auto">
                        <a href={hosts?.tiktokurl} target="_blank" className="font-medium">
                        {hosts?.tiktokurl}
                        </a>
                    </div>
                    </div>
                ...
                {hosts?.youtubeurl != "" &&
                    ...
                    <div className=" mr-auto">
                        <a href={hosts?.youtubeurl} target="_blank" className="font-medium">
                        {hosts?.youtubeurl}
                        </a>
                    </div>
                    </div>
            ...
            <div className="col-span-12 intro-y box 2xl:col-span-6">
              <div className="flex items-center px-5 py-5 border-b sm:py-3 border-slate-200/60 dark:border-darkmode-400">
                <h2 className="mr-auto text-base font-medium">OTHER LINKS</h2>
              </div>
              <div className="p-5">
              {hosts?.yelp != "" &&
                <div className="relative flex items-center">
                  ...
                  <div className=" mr-auto">
                    <a href={hosts?.yelp} target="_blank" className="font-medium">
                      {hosts?.yelp}
                    </a>
                  </div>
                </div>
                ...
                <div className="relative flex items-center">
                  ...
                  <div className=" mr-auto">
                    <a href={hosts?.bbb} target="_blank" className="font-medium">
                      {hosts?.bbb}
                    </a>
                  </div>
                </div>
                ...
                <div className="relative flex items-center">
                  ...
                  <div className=" mr-auto">
                    <a href={hosts?.bing} target="_blank" className="font-medium">
                      {hosts?.bing}
                    </a>
                  </div>
                </div>
                ...
                {hosts?.tripadvisor != "" &&
                    ...
                    <div className=" mr-auto">
                        <a href={hosts?.tripadvisor} target="_blank" className="font-medium">
                        {hosts?.tripadvisor}
                        </a>
                    </div>
                    </div>
                ...
                {hosts?.angie != "" &&
                    ...
                    <div className=" mr-auto">
                        <a href={hosts?.angie} target="_blank" className="font-medium">
                        {hosts?.angie}
                        </a>
                    </div>
                    </div>
                ...
                {hosts?.opentable != "" &&
                    ...
                    <div className=" mr-auto">
                        <a href={hosts?.opentable} target="_blank" className="font-medium">
                        {hosts?.opentable}
                        </a>
                    </div>
                    </div>
                ...
                {hosts?.trustpilot != "" &&
                    ...
                    <div className=" mr-auto">
                        <a href={hosts?.trustpilot} target="_blank" className="font-medium">
                        {hosts?.trustpilot}
                        </a>
                    </div>
                    </div>
